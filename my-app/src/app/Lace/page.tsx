...
const Lace = () => {
  ...
  return (
    <section
      ...
      aria-label="Free Standing Lace Embroidery Digitizing Portfolio"
    >
          ...
          {items.map((item, index) => (
            <div key={index} className="lg:w-1/4 md:w-1/2 p-4 w-full">
              ...
              <div className="relative h-48 rounded overflow-hidden group cursor-pointer">
                <Image
                  alt="Free standing lace embroidery design"
                  src={item.img}
                  width={400}
                  height={300}
        ...
        >
          ...
          >
            ...
            <div onClick={toggleZoom} className="cursor-zoom-in">
              <Image
                src={selectedImage}
                alt="Free standing lace embroidery preview"
                width={700}
                height={500}
                className="rounded-lg transition-transform duration-300 max-w-[80vw] max-h-[80vh] object-contain"
                style={{
